...
&lt;!--cell-hovered(鼠标单元格悬浮效果)--&gt;
&lt;table class="table cell-hovered"&gt;...&lt;/table&gt;
&lt;!--border(外边界效果)--&gt;
