<template>
  <div v-if="show" class="vi-loading">
    <section class="cover-mask"></section>
    <div class="loading-panel">
      <svg width='80' height='80' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" class="uil-default">  
